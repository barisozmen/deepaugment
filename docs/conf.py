...
extensions = [
    ...
    # Modern extensions
    "sphinx_design",                # Beautiful UI components (cards, grids, tabs)
    "myst_parser",                  # Markdown support (optional, for future)
]
...
html_theme_options = {
    ...
    "dark_css_variables": {
        "color-brand-primary": "#60A5FA",  # Light blue
        "color-brand-content": "#93C5FD",
    },
    "sidebar_hide_name": False,
    "navigation_with_keys": True,
    "source_repository": "https://github.com/barisozmen/deepaugment",
...
html_title = f"DeepAugment {version}"
html_short_title = "DeepAugment"
...
latex_documents = [
    ("index", "deepaugment.tex", "DeepAugment Documentation", author, "manual"),
]

# Man page output (optional)
man_pages = [
    ("index", "deepaugment", "DeepAugment Documentation", [author], 1)
]
